<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="search2.aspx.cs" Inherits="Movies.search2" %>
    ...
    <link type="text/css" rel="stylesheet" href="Search.css" />
        <div class="searchContainer">
            <div class="search1">
                ...
                <asp:Label ID="lable2" runat="server" Text="Genres" Width="226px" /><br />
                <asp:TextBox ID="tbGenre1" runat="server" /><br />
                <asp:TextBox ID="genre2" runat="server" /><br />
            ...
            <div class="search2">
                ...
                <asp:TextBox ID="yearFrom" Width="149px" runat="server" />
